...
<form action="{{ route('leave.encashment.store') }}" method="POST" enctype="multipart/form-data">@csrf
        ...
        <div class="form-group mb-3 col-lg-6">
            ...
            <div class="form-group mb-3 row">
                <div class="col-lg-3"><label class="mb-2 form--label text--white">Encashment Days</label><span
                        class="text-danger">*</span></div>
                <div class="col-lg-9">
                    <input type="number" name="encashment_day" id="encashment_day" class="form-control form-control-sm"
                        value="{{ old('encashment_day') }}" required>
                </div>
            </div>
            <div class="form-group mb-3 row">
                <div class="col-lg-3"><label class="mb-2 form--label text--white">Encashment Amount</label><span
                        class="text-danger">*</span></div>
                <div class="col-lg-9">
                    <input type="number" name="encashment_amount" id="encashment_amount"
                        class="form-control form-control-sm" value="{{ old('encashment_amount') }}" required>
                    <small>(Monthly Gross rate of pay** x 12 months) / (52 weeks x number of working days each week) x
                        No. of leave days left to encash</small>
                </div>
            </div>
            <div class="form-group mb-3 row">
                ...
                <div class="col-lg-9">
                    <input type="text" id="month_to_apply" class="form-control month input-sm"
                        ...
                        value="{{ isset($month) ? $month : old('month') }}" readonly autocomplete="off" required />
